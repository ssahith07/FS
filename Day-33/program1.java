// In a garden, there is a row of plants. The gardener need to water them
// regularly.
// In the row of plants, some are empty places some are plants. you need to
// setup
// the watering kits to water the row of plants at the empty places. A watering
// kit
...
// You are given a string 'plants', consists of two characters only [P,E], where
// P
...
// Explanation:
// ------------
// You can setup watering kits at index-1, index-5, so all the 3 plants gets
// water.
